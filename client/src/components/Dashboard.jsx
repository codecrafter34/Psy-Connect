...
const Dashboard = () => {
  ...
  const handleEmotionCapture = async (imageData) => {
    ...
    try {
      ...
      const newRecord = { ...result.data, timestamp: new Date(result.data.timestamp) };
          ...
          <div className="space-y-6">
            ...
            <Card className="p-6">
              ...
              <div className="space-y-3">
                {summary?.weeklyTrends?.length > 0 ? (
                  summary.weeklyTrends.map((trend) => (
                    <MoodTrend 
                      key={trend.emotion} 
            ...
            <Card className="p-6 bg-gradient-to-br from-primary/10 via-background to-accent/10 border-primary/20">
              <div className="flex flex-col items-center text-center space-y-4">
                ...
                <div>
                  <h3 className="text-lg font-bold mb-1">AI Wellness Hub</h3>
                  <p className="text-sm text-muted-foreground">Get personalized music, food, and activity suggestions based on your mood.</p>
                </div>
                <Button 
